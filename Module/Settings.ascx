<%@ Control Language="C#" AutoEventWireup="false" Inherits="DnnCart.Settings" Codebehind="Settings.ascx.cs" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DnnCart Settings Design Table">
    <tr>
